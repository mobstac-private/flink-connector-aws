...
import static org.apache.flink.connector.dynamodb.table.DynamoDbConnectorOptions.SPARSE_UPDATE;
...
public class DynamoDbConfiguration {
    ...
    public boolean getSparseUpdate() {
        return tableOptions.get(SPARSE_UPDATE);
    }
